...
<script>
    ...
    var data_dict = {};
    data_dict["no_of_athletes"] = {"name":"No. of Participating Athletes","data":[]};;
    data_dict["category"] = [];
    for (var i = 0; i < dis_data.length ; i++)
    {
        data_dict["no_of_athletes"]["data"].push(dis_data[i].no_of_athletes*1.0);
    ...
    Highcharts.chart('participationbar', {
            ...
            title: {
                text: 'Disicipline Wise Distribution of Participating Athletes'
            },
            xAxis: {
        ...
        fontWeight: 'bold',
            ...
            series: [data_dict["no_of_athletes"]],
            exporting: {
                enabled: false
            }
        });
