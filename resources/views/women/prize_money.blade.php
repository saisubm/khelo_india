...
<script>
    ...
    var data_dict = {};
    data_dict["prize_money_decided"] = {"name":"Prize Money (in Lakhs)","data":[]};;
   
    data_dict["category"] = [];
    for (var i = 0; i < dis_data.length ; i++)
    {
        data_dict["prize_money_decided"]["data"].push(dis_data[i].prize_money_decided*1.0 / 100000);
    ...
    Highcharts.chart('participationbar', {
            ...
            title: {
                text: 'Discipline Wise distribution of Prize Money'
            },
            xAxis: {
        ...
        fontWeight: 'bold',
            ...
            tooltip: {
                formatter: function() {
                    ...
                    return '<b>' + this.series.name + ': </b>' + this.y + '(In Lakhs)<br/>';
                }
            },
            series: [data_dict["prize_money_decided"]],
            exporting: {
                enabled: false
            }
        });
