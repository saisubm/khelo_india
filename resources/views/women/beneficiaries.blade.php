...
<script>
    ...
    var data_dict = {};
    data_dict["beneficiaries"] = {"name":"Beneficiaries","data":[]};;
   
    data_dict["category"] = [];
    for (var i = 0; i < dis_data.length ; i++)
    {
        data_dict["beneficiaries"]["data"].push(dis_data[i].beneficiaries_as_of_now*1.0);
    ...
    Highcharts.chart('participationbar', {
            ...
            title: {
                text: 'Disciplines Wise distribution of Beneficiaries'
            },
            xAxis: {
        ...
        fontWeight: 'bold',
            ...
            series: [data_dict["beneficiaries"]],
            exporting: {
                enabled: false
            }
        });
