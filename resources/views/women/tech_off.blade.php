...
<script>
    ...
    var data_dict = {};
    data_dict["tech_off"] = {"name":"Technical Officials","data":[]};;
   
    data_dict["category"] = [];
    for (var i = 0; i < dis_data.length ; i++)
    {
        data_dict["tech_off"]["data"].push(dis_data[i].no_of_technical_officials*1.0);
    ...
    Highcharts.chart('participationbar', {
            ...
            title: {
                text: 'Discipline Wise distribution of Technical Officials'
            },
            xAxis: {
