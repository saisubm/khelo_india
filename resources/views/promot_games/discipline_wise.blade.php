...
<div class="state-wise-count py-5">
    <div class="container">
        <div class="row align-items-center" style="font-size: 33px; font-weight:700; padding:0px; border-radius:7px; border: 1px solid #AFAFB4;">
            <div class="col-lg-1 col-md-2 col-3">
                <button type="button" onclick="{history.back()}" class="background-light border-0 d-flex"
            ...
            <div class="col-lg-11 col-md-10 col-9" >
                {{-- <h2 class="text-center" style="font-family: 'Antonio', sans-serif !important;">State-wise Data of KISCE
                </h2> --}}
                <div class="text-center ">
                    <h1 class="text-center py-2" style="font-size: 33px; font-weight:700;"><img src=" {{ asset('public/front/assets/images/svg/Athletes-support.svg') }}"
                        class="me-1"	alt="">Academies under {{$discipline ?? ''}}</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row my-5">
           ...
           <div class='border py-2'>
                <div id="viewDiv" title="Hover on the State/UT to know the details of the Academies" style="min-height: 95vh !important;padding:2px 0px; ">
                    {{-- <img src="images/svg/state-wise-data.svg" alt=""> --}}
                </div>
                <div class="row justify-content-center py-1">
                        <div class="col-md-8 col-12">
                            <div class="progress" style="height: 25px">
                                <div class="progress-bar text-dark fs-6 " title="Academies not Present" role="progressbar" style="background-color:#fee5d9; width: 50%;"><span class="spl_text">Academies not Present</span></div>
                                <div class="progress-bar  text-dark fs-6 " title="Academies Present" role="progressbar" style="background-color:6baed6; width: 50%;"><span class="spl_text">Academies Present</span></div>
...
<script>
    var data = <?php echo $discipline_wise; ?>;
    ...
    require(["esri/config",
        ...
        function demo_function(feature) {
            ...
            if(!(feature.graphic.attributes.STCODE11 in data_dict_status))
            {
                return `
          <div class="col-12">
            <h6 class="text-center" >Academies in the State/UT of ` + feature.graphic.attributes.STNAME + `</h6>
 ...
 <tbody>
    <tr>
        <td colspan="3" class="text-center">
            No Academy found in this State/UT for this Discipline
        </td>
        </tr>
           ...
           `;
            ...
            for (let i = 0; i < data_dict_status[feature.graphic.attributes.STCODE11].length; i++) {
                ...
                html += `<tr>
     <td >${i+1}</td>
     <td>${data_dict_status[feature.graphic.attributes.STCODE11][i]['center_name']}</td>
 ...
 <tbody>
   ${html}
        ...
        //                 window.location.href = "{{ url('kisce-details') }}/" + encodeURIComponent(
        //                     window.btoa(response.results[0].graphic.attributes.STCODE11));
