       ...
       <div class="row w-100">
           <div class="col-sm-6 d-flex align-item-center justify-content-center">
            <div class="login-box my-auto">
                ...
                {{-- <div class="logo_wrap">
                    <a href="http://localhost:8080/infra_dashboard"><img src="http://localhost:8080/infra_dashboard/public/front/assets/images/new_logo.svg" alt="" class="img-fluid"></a>
                </div> --}}
                <!-- /.login-logo -->
                <div class="card">
                    <div class="card-body login-card-body">
                        <div class="logo_wrap px-4">
                        ...
                        <form  id="login_form" method="post" action="{{ route('admin.reset.password.post') }}" autocomplete="off" >
                            @csrf
                            ...
                            <div><button type="submit" class="btn btn-primary btn-block text-uppercase">Reset Password</button></div>
                        </form>
                    </div>
                    <!-- /.login-card-body -->
                </div>
